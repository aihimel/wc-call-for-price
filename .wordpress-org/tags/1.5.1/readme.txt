...
If you feel like you would like to suggest any new feature you can open a support ticket [here](https://wordpress.org/support/plugin/wc-call-for-price/#new-topic-0). Usually we do add features as per user’s request.
...
* Supports AWS(Amazon Web Services)
...
* 🪛 **Tweak:** License Update to GPLv3

= 1.1.1 =
* 🪛 **Tweak:** Backend font issue has been fixed
* 🪛 **Tweak:** Clash with some other plugin has been fixed

= 1.1 =
* 🧩 **Compatibility:** Tested for version 4.4.1
